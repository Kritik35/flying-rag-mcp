...
`АТ-РД-ОВ2-С-00-СО (ПДВ).xlsx` с 4001 непустой строкой, из которых половина
...
# Как в `АТ-РД-ОВ1-С-00-СО-03.xlsx`: данные с нулевой строки, шапки нет.
HEADERLESS = [
...
# Как в `АТ-РД-ОВ2-С-00-СО (ПДВ).xlsx`: заголовок раздела, затем данные.
